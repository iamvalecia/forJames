...
function resizeList() {    
  ...
  var ListRatio = List.config.width / List.config.height;    
  if(windowRatio < ListRatio) {        
    ul.style.width = windowWidth + "px";        
    ul.style.height = (windowWidth / ListRatio) + "px";    
  }else{        
    ul.style.width = (windowHeight * ListRatio) + "px";        
    ul.style.height = windowHeight + "px";    
  } 
}
